...
"""ug2html.py -- Creates HTML version of EUAP User Guide
...
def create_userguide():
    ...
    #sys.path.insert(0, os.path.join(ugdir, '..', '..', 'src', 'web', 'deuap'))
    ...
    description = 'HTML generator for Robogenerator User Guide.'
    arguments = '''
--time
...
def create_distribution():
    ...
    outdir = 'robogenerator-userguide-%s' % version
