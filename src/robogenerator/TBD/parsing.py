...
from rules import AndRule, Condition, EquivalenceRule, OrRule, NotRule, ImplicationRule, UnequalCondition
...
states = state+ZeroOrMore(OneOrMore(LineEnd())+state)+ZeroOrMore(end_of_line)
